...
export const MODContent = {
  'wormbase': {
    ...
    search: [
      ['<i>C. elegans</i>', 'search?q=Caenorhabditis elegans&category=gene'],
    ],
    resources: [
...
//       ' the UK Medical Research Council and the UK Biotechnology and Biological Sciences Research Council.',
  ...
  'sgd': {
    ...
    search: [
      ['<i>S. cerevisiae</i>', 'search?q=Saccharomyces cerevisiae&category=gene'],
    ],
    resources: [
  ...
  'zfin': {
    ...
    fetchNewsCount: 3,
    search: [
      ['<i>D. rerio</i>', 'search?q=Danio rerio&category=gene'],
    ],
    resources: [
  ...
  'flybase': {
    ...
    search: [
      ['<i>D. melanogaster</i>', 'search?q=Drosophila melanogaster&category=gene'],
    ],
    resources: [
  ...
  'rgd': {
    ...
    search: [
      ['<i>R. norvegicus</i>', 'search?q=Rattus norvegicus&category=gene'],
    ],
    resources: [
  ...
  'mgd': {
    ...
    search: [
      ['<i>M. musculus</i>', 'search?q=Mus musculus&category=gene'],
    ],
    resources: [
