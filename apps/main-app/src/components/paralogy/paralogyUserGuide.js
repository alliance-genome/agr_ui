...
const ParalogyUserGuide = () => (
  <div>
    ...
    <p>
      ...
      paralog. For noncoding RNA genes, currently only HGNC and ZFIN
      curated paralogs are included.
    </p>
    <p>
      The DIOPT approach allows flexibility in the choice of algorithms and
      in the level of stringency applied. For the Paralogy table, these
