...
*/
    ...
    const stage_paths = [
      ...
      { source: '/alliancemine/',                      target: 'https://stage-intermine-tomcat.alliancegenome.org/alliancemine/',                     status: amplify.RedirectStatus.REWRITE },
      { source: '/alliancemine/<*>',                   target: 'https://stage-intermine-tomcat.alliancegenome.org/alliancemine/<*>',                  status: amplify.RedirectStatus.REWRITE },
      { source: '/bluegenes',                          target: 'https://stage.alliancegenome.org/bluegenes/',                                         status: amplify.RedirectStatus.PERMANENT_REDIRECT },
      { source: '/bluegenes/',                         target: 'https://stage-bluegenes.alliancegenome.org/bluegenes/',                               status: amplify.RedirectStatus.REWRITE },
      { source: '/bluegenes/<*>',                      target: 'https://stage-bluegenes.alliancegenome.org/bluegenes/<*>',                            status: amplify.RedirectStatus.REWRITE },
