...
export class AmplifyALBStack extends cdk.Stack {
  constructor(scope: cdk.App, id: string, props: MultistackProps) {
    ...
    const cert = elbv2.ListenerCertificate.fromArn(
      'arn:aws:acm:us-east-1:100225593120:certificate/047a56a2-09dd-4857-9f28-32d23650d4da'
    );
    const targetInstance = new targets.InstanceIdTarget(props.targetInstanceId);
    const public_zone = route53.HostedZone.fromHostedZoneAttributes(this, 'Public Zone', {
      zoneName: 'alliancegenome.org',
      hostedZoneId: 'Z3IZ3D6V94JEC2',
    });
    const private_zone = route53.HostedZone.fromHostedZoneAttributes(this, 'Private Zone', {
      zoneName: 'alliancegenome.org',
