...
*/
    ...
    const test_paths = [
      {
        source: '/api/<*>',
        target: 'https://test-alb.alliancegenome.org/api/<*>',
        status: amplify.RedirectStatus.REWRITE,
      },

      {
        source: '/jbrowse2',
        target: 'https://test.alliancegenome.org/jbrowse2/',
      ...
      },
      {
        ...
        target: 'https://test.alliancegenome.org/jbrowse/worms/protein/',
        status: amplify.RedirectStatus.PERMANENT_REDIRECT,
      },
      {
        source: '/jbrowse/worms/protein/',
      ...
      },
      {
        ...
        target: 'https://test.alliancegenome.org/jbrowse/worms/jbrowse-simple/',
        status: amplify.RedirectStatus.PERMANENT_REDIRECT,
      },
      {
        source: '/jbrowse/worms/jbrowse-simple/',
      ...
      },
      {
        ...
        target: 'https://test.alliancegenome.org/jbrowse/worms/jbrowse/',
        status: amplify.RedirectStatus.PERMANENT_REDIRECT,
      },
      {
        source: '/jbrowse/worms/jbrowse/',
      ...
      },
      {
        ...
        target: 'https://test.alliancegenome.org/jbrowse/worms/jbrowse2/',
        status: amplify.RedirectStatus.PERMANENT_REDIRECT,
      },
      {
        source: '/jbrowse/worms/jbrowse2/',
      ...
      {
        source: '/jbrowse/<*>',
        target: 'https://test-alb.alliancegenome.org/jbrowse/<*>',
        status: amplify.RedirectStatus.REWRITE,
      },
      {
        source: '/apollo/<*>',
        target: 'https://test-alb.alliancegenome.org/apollo/<*>',
        status: amplify.RedirectStatus.REWRITE,
      },
      ...
      {
        source: '/openapi',
        target: 'https://test-alb.alliancegenome.org/openapi',
        status: amplify.RedirectStatus.REWRITE,
      },
      ...
      },
      {
        ...
        target: 'https://test.alliancegenome.org/textpresso/wb/tpc',
        status: amplify.RedirectStatus.PERMANENT_REDIRECT,
      },
      {
        source: '/textpresso/wb/',
      ...
      },
      {
        ...
        target: 'https://test.alliancegenome.org/textpresso/mgi/tpc',
        status: amplify.RedirectStatus.PERMANENT_REDIRECT,
      },
      {
        source: '/textpresso/mgi/',
      ...
      },
      {
        ...
        target: 'https://test.alliancegenome.org/textpresso/zfin/tpc',
        status: amplify.RedirectStatus.PERMANENT_REDIRECT,
      },
      {
        source: '/textpresso/zfin/',
      ...
      },
      {
        ...
        target: 'https://test.alliancegenome.org/textpresso/fb/tpc',
        status: amplify.RedirectStatus.PERMANENT_REDIRECT,
      },
      {
        source: '/textpresso/fb/',
      ...
      {
        source: '/blast',
        target: 'https://test.alliancegenome.org/blastservice',
        status: amplify.RedirectStatus.PERMANENT_REDIRECT,
      },
      {
        source: '/blast/',
