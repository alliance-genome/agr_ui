...
export const SPECIES = [
  {
    ...
    jBrowseOrthologyTracks: 'human2fly.filter.anchors,human2mouse.filter.anchors,human2rat.filter.anchors,human2worm.filter.anchors,human2xenopuslaevis.filter.anchors,human2xenopustropicalis.filter.anchors,human2yeast.filter.anchors,human2zebrafish.filter.anchors',
    vertebrate: true,
  ...
  },
  {
    ...
    jBrowseOrthologyTracks:'human2mouse.filter.anchors,mouse2fly.filter.anchors,mouse2worm.filter.anchors,mouse2xenopustropicalis.filter.anchors,mouse2yeast.filter.anchors,mouse2zebrafish.filter.anchors,rat2mouse.filter.anchors',
    vertebrate: true,
    enableSingleCellExpressionAtlasLink: true,
    enableOrthologComparison: true,
  },
  {
    ...
    jBrowseOrthologyTracks:'human2rat.filter.anchors,rat2fly.filter.anchors,rat2mouse.filter.anchors,rat2worm.filter.anchors,rat2xenopustropicalis.filter.anchors,rat2yeast.filter.anchors,rat2zebrafish.filter.anchors',
    vertebrate: true,
    enableSingleCellExpressionAtlasLink: true,
    enableOrthologComparison: true,
  },
  {
    ...
    jBrowseOrthologyTracks:'human2xenopuslaevis.filter.anchors,xenopuslaevis2xenopustropicalis.filter.anchors',
    vertebrate: true,
  ...
  },
  {
    ...
    jBrowsetracks: '_all_genes,_ht_variants,_variants',
    jBrowseOrthologyTracks:'human2zebrafish.filter.anchors,mouse2zebrafish.filter.anchors,rat2zebrafish.filter.anchors,zebrafish2fly.filter.anchors,zebrafish2worm.filter.anchors,zebrafish2xenopustropicalis.filter.anchors,zebrafish2yeast.filter.anchors',
    vertebrate: true,
    enableSingleCellExpressionAtlasLink: true,
    enableOrthologComparison: true,
  },
  {
    ...
    jBrowsetracks: '_all_genes,_ht_variants,_variants,_multiple-variant_alleles',
    jBrowseOrthologyTracks:'fly2yeast.filter.anchors,human2fly.filter.anchors,mouse2fly.filter.anchors,rat2fly.filter.anchors,worm2fly.filter.anchors,xenopustropicalis2fly.filter.anchors,zebrafish2fly.filter.anchors',
    vertebrate: false,
    enableSingleCellExpressionAtlasLink: true,
    enableOrthologComparison: true,
  },
  {
    ...
    jBrowsetracks: '_all_genes,_ht_variants,_variants',
    jBrowseOrthologyTracks:'human2worm.filter.anchors,mouse2worm.filter.anchors,rat2worm.filter.anchors,worm2fly.filter.anchors,worm2yeast.filter.anchors,xenopustropicalis2worm.filter.anchors,zebrafish2worm.filter.anchors',
    vertebrate: false,
    enableSingleCellExpressionAtlasLink: true,
    enableOrthologComparison: true,
  },
  {
    ...
    jBrowsetracks: '_all_genes,_ht_variants',
    jBrowseOrthologyTracks:'fly2yeast.filter.anchors,human2yeast.filter.anchors,mouse2yeast.filter.anchors,rat2yeast.filter.anchors,worm2yeast.filter.anchors,xenopustropicalis2yeast.filter.anchors,zebrafish2yeast.filter.anchors',
    vertebrate: false,
    enableSingleCellExpressionAtlasLink: true,
    enableOrthologComparison: true,
  },
