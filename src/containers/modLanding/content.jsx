...
export const MODContent = {
  wormbase: {
    about:
      '<p>WormBase is an international consortium of biologists and computer scientists providing the research ' +
    ...
    search: [['<i>C. elegans</i>', '/search?species=Caenorhabditis elegans&category=gene_search_result']],
    resources: [
      [
        'WormBase Guidelines for Nomenclature',
  ...
  sgd: {
    about:
      '<p>The Saccharomyces Genome Database (SGD) provides comprehensive integrated biological information for the ' +
    ...
    logoImgSrc: sgdLogo,
    hasMeetings: true,
    googleapisMeetingsBaseURL:
      'https://www.googleapis.com/calendar/v3/calendars/mhv058nk936st3jd3qjernajdk@group.calendar.google.com/events?key=AIzaSyDXypHUsRcWWBx2UClUV_wrag8TIlNYbSc',
    ...
    search: [['<i>S. cerevisiae</i>', '/search?species=Saccharomyces cerevisiae&category=gene_search_result']],
    resources: [
  ...
  zfin: {
    about:
      '<p>The Zebrafish Information Network (ZFIN) is the database of genetic and genomic data for the zebrafish ' +
    ...
    fetchNewsCount: 3,
    search: [['<i>D. rerio</i>', '/search?species=Danio rerio&category=gene_search_result']],
    resources: [
    ...
    footer: [
      ...
      [
        '',
        'Zebrafish Anatomy Atlases and Resources',
        'https://zfin.atlassian.net/wiki/spaces/general/pages/1892876451/Anatomy+Atlases+and+Resources',
      ],
  ...
  flybase: {
    about:
      '<p>FlyBase (flybase.org) is an essential online database for researchers using <i>Drosophila melanogaster</i> ' +
    ...
    search: [['<i>D. melanogaster</i>', '/search?species=Drosophila melanogaster&category=gene_search_result']],
    resources: [
  ...
  rgd: {
    about:
      '<p>The Rat Genome Database (RGD) is the primary site for genetic, genomic, phenotype, and disease-related ' +
    ...
    search: [['<i>R. norvegicus</i>', '/search?species=Rattus norvegicus&category=gene_search_result']],
    resources: [
  ...
  mgd: {
    about:
      '<p>The Mouse Genome Database (MGD) is the database resource for the laboratory mouse, and ' +
    ...
    search: [['<i>M. musculus</i>', '/search?species=Mus musculus&category=gene_search_result']],
    resources: [
  ...
  goc: {
    about:
      '<p>The mission of the GO Consortium is to develop a comprehensive, computational model of biological systems, ' +
  ...
  xenbase: {
    about:
      '<p>Xenbase’s mission is to provide a comprehensive, integrated and easy to use website that gives ' +
    ...
    search: [
      ['<i>Xenopus laevis</i>', '/search?species=Xenopus laevis&category=gene_search_result'],
      ['<i>Xenopus tropicalis</i>', '/search?species=Xenopus tropicalis&category=gene_search_result'],
    ],
    resources: [
      ['<i>Xenopus</i> Gene Search', 'https://www.xenbase.org/xenbase/gene/gene.do'],
      [
        '<i>Xenopus</i> Gene Expression',
        'https://www.xenbase.org/xenbase/geneExpression/geneExpressionSearch.do?method=display',
      ],
      ...
      [
        '<i>Xenopus</i> Disease Models',
        'https://www.xenbase.org/xenbase/searchPhenotype.do?method=display&keyword=disease&tabName=disease',
      ],
      [
        '<i>Xenopus</i> Lines & Mutants',
        'https://www.xenbase.org/xenbase/stockCenter/searchLines.do?supplier=&searchIn=1&searchValue=*&searchSpecies=11&orderBy=CREATE_DATE&orderDirection=DESC&method=searchLines',
      ],
