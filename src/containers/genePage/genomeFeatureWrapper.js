...
class GenomeFeatureWrapper extends Component {
  ...
  constructor(props) {
    super(props);
    let apolloServerPrefix = process.env.APOLLO_URL+'/apollo/';
    ...
    let externalJBrowsePrefix = `${process.env.JBROWSE_URL || ''}/jbrowse/?`+'data=data%2F' + encodeURIComponent(this.props.species);
