...
import { DataTable, ReferenceCell } from '../../components/dataTable';
import hash from 'object-hash';
import AnnotatedEntitiesPopup from '../../components/dataTable/AnnotatedEntitiesPopup.jsx';
import useDataTableQuery from '../../hooks/useDataTableQuery';

const AlleleToPhenotypeTable = ({ alleleId }) => {
  const { data: results, ...tableProps } = useDataTableQuery(`/api/allele/${alleleId}/phenotypes`);
