  ...
  render() {
    return (
      ...
      >
        ...
        <p>The Alliance methodology for the identification of orthologs among human and Alliance organisms is currently built on the DRSC Integrative Ortholog Prediction Tool (
          <ExternalLink href="http://www.flyrnai.org/diopt" />
        ). DIOPT integrates a number of existing approaches including Emsembl Compara, HGNC, InParanoid, OMA, PANTHER, PhylomeDB, Roundup, TreeFam, and ZFIN, and assigns a score/count based on these different methods.</p>
      </CollapsiblePanel>
    );
  }
}
