export default function RankHelp() {
  return (
    <div>
      <p>
        The ranking score is calculated using a weighted formula: Score = w₁ x (Alignment Length x Similarity %) + w₂ x
        (Alignment Length x Identity %) + w₃ x (Method Count) + w₄ x (Alignment Length).
      </p>
      <p>Where the weights are as follows:</p>
      <ul>
      ...
      <p>Multiple entries can share the same rank.</p>
    </div>
  );
}
