...
export default function ParalogyUserGuide() {
  ...
  <div>
    <p>
      ...
      common set of paralogy relationships among genes for the organisms
      ...
      ortholog inferences from HGNC (for human and mouse genes), and SGD (for yeast genes).
    </p>
    <p>
      The paralog inferences from the different methods have been
      ...
      those used by the Alliance: Ensembl Compara, HGNC, InParanoid, 
      OMA, OrthoFinder, OrthoInspector, PANTHER, PhylomeDB, 
      SonicParanoid and SGD. See the <ExternalLink href='https://fgr.hms.harvard.edu/diopt-documentation'>
      ...
      paralog. For noncoding RNA genes, currently only HGNC curated 
