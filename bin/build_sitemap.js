...
var sitemapindex = sm.buildSitemapIndex({
  urls: ['https://www.alliancegenome.org/main-sitemap.xml'],
});
...
var sitemap = sm.createSitemap({
  ...
  urls: [
    ...
    {
      url: '/organization-and-governance',
      changefreq: 'monthly',
      priority: 0.7,
      lastmodrealtime: true,
    },
    {
      url: '/privacy-warranty-licensing',
      changefreq: 'monthly',
      priority: 0.7,
      lastmodrealtime: true,
    },
    ...
    {
      url: '/administrative-supplement',
      changefreq: 'monthly',
      priority: 0.7,
      lastmodrealtime: true,
    },
    {
      url: '/phenotypes-and-disease-models',
      changefreq: 'monthly',
      priority: 0.7,
      lastmodrealtime: true,
    },
